        ...
        <div class="col-md-12">
          ...
          <form class="" method="post" action="controleUsuario.php">
            <div class="form-group">
              ...
              <input type="text" class="form-control" placeholder="Digite o seu email" id="email" name="email"> </div>
            <div class="form-group">
              <label for="senha">Senha
                <b></b>
              </label>
              <input type="password" class="form-control" placeholder="Digite a sua senha" id="email" name="senha"> </div>
            <buton class="btn btn-primary" name="opcao" value="Ir Cadastro">Entrar </buton>
            <a class="btn btn-primary" href="cadastrarLogin.php">Cadastrar-se</a>
          </form>
        </div>
      </div>
    </div>
