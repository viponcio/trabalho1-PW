        ...
        <div class="col-md-12">
          ...
          <form class="">
            <div class="form-group">
              ...
              <input type="email" class="form-control" placeholder="Nome do Autor"> </div>
            <div class="form-group">
              <label>Nome do Livro</label>
              <input type="email" class="form-control" placeholder="Nome do Livro"> </div>
            <div class="form-group">
              <label>Nome do Autor</label>
              <input type="email" class="form-control" placeholder="Nome da Editora"> </div>
          </form>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
          ...
          <form class="" method="post" action="controleEstoque.php">
            ...
            <button class="btn btn-primary" name="opcao" value="Alterar">Alterar</button>
